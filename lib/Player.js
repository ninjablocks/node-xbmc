  ...
  Player = (function() {
    ...
    Player.open = function(item, options, fn) {
      ...
      return dfd.then(function(data) {
        Player.api.emit('player.open', data);
        if (fn) {
          return fn(data);
        }
      });
    ...
    Player.getActivePlayers = function(fn) {
      ...
      return dfd.then(function(data) {
        Player.api.emit('player.activePlayers', data);
        if (fn) {
          return fn(data);
        }
      });
    ...
    Player.playPause = function(fn) {
      ...
      return Player.getActivePlayers(function(data) {
        ...
        return dfd.then(function(data) {
          _this.api.emit('player.playpause', data);
          if (fn) {
            return fn(data);
          }
        });
    ...
    Player.stop = function(fn) {
      ...
      return Player.getActivePlayers(function(data) {
        ...
        return dfd.then(function(data) {
          _this.api.emit('player.stop', data);
          if (fn) {
            return fn(data);
          }
        });
    ...
    Player.rewind = function(forward, fn) {
      ...
      return Player.getActivePlayers(function(data) {
        ...
        return dfd.then(function(data) {
          _this.api.emit('player.setspeed', data);
          if (fn) {
            return fn(data);
          }
        });
